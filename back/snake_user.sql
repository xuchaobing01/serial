...
insert into `snake_user`(`id`,`username`,`password`,`loginnum`,`last_login_ip`,`last_login_time`,`real_name`,`status`,`typeid`,`serialnum`,`maxtimes`,`maxnum`,`pid`,`son`,`deptid`) values('1','admin','21232f297a57a5a743894a0e4a801fc3','187','127.0.0.1','1484132932','admin','1','1','1','0','0','0','','0');
