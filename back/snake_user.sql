...
insert into `snake_user`(`id`,`username`,`password`,`loginnum`,`last_login_ip`,`last_login_time`,`real_name`,`status`,`typeid`,`serialnum`,`maxtimes`,`maxnum`,`pid`,`son`) values('1','admin','21232f297a57a5a743894a0e4a801fc3','168','127.0.0.1','1483887200','admin','1','1','1','0','0','0','');
...
insert into `snake_user`(`id`,`username`,`password`,`loginnum`,`last_login_ip`,`last_login_time`,`real_name`,`status`,`typeid`,`serialnum`,`maxtimes`,`maxnum`,`pid`,`son`) values('74','李四','dc3a8f1670d65bea69b7b65048a0ac40','3','127.0.0.1','1483886609','李四','1','3','3','5','20','73','75');
