...
insert into `snake_user`(`id`,`username`,`password`,`loginnum`,`last_login_ip`,`last_login_time`,`real_name`,`status`,`typeid`,`serialnum`) values('1','admin','21232f297a57a5a743894a0e4a801fc3','82','127.0.0.1','1480597968','admin','1','1','30');
